# ai-sdk-middleware-logging

## Purpose

Optional AI SDK Language Model Middleware for logging AI model request/response payloads at the SDK level, with built-in safety features (redaction, truncation) and configurable gating (environment-based enablement and sampling).
